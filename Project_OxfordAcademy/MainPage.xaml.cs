...
namespace Project_OxfordAcademy
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            teachers = new TeacherInformation();
            this.listTeacher.ItemsSource = teachers.Get();
        }

        private void listTeachers_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            Teacher t = listTeacher.SelectedItem as Teacher;
            this.Frame.Navigate(typeof(Details), new NavParam { Data = t.ID });
        }
    }
}
